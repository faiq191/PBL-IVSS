    ...
    <div class="flex flex-col items-center justify-center bg-none p-8 rounded-lg w-full max-w-md bg-white">
        ...
        <a href="index.html">
            <div class="flex gap-4 items-center mb-6">
                <img src="assets/img/ROBOT.jpg" class="h-14" alt="Logo">
        ...
        <!-- Login Button -->
        <a href="{{ route('halaman.admin') }}" class="bg-primary rounded-xl text-white w-full text-center py-3 font-semibold hover:bg-primary-dark transition">
            Masuk
        </a>
    </div>
</body>
